...
// 🚀 프로퍼티 세도잉(Property Shadowing)이란?
// 같은 이름의 프로퍼티나 메서드가 인스턴스와 프로토타입 양쪽에 존재할 때, 인스턴스의 프로퍼티가 우선된다.
// 즉, 프로토타입 메서드(prototype.sayHello)보다 인스턴스 메서드(this.sayHello)가 먼저 호출됨.
